export function GoBack() {
  ...
  return (
    <button
      onClick={goBack}
      className=" w-12 h-12 bg-primaryLight text-white rounded-full absolute left-6 sm:left-12 md:left-16 lg:left-28 flex justify-center items-center transition-all hover:transform hover:scale-105"
    >
      <svg
